...
export default function Footer() {
    ...
    return (
        <footer className="bg-black px-6 py-16 text-white rounded-2xl">
  <div className="mx-auto flex max-w-7xl flex-col gap-12 md:flex-row md:items-end md:justify-between">
    ...
    <div className="space-y-4 text-sm uppercase tracking-[0.2em] text-neutral-400">
      ...
      <div className="flex gap-6 pt-4">
        <a href="https://instagram.com" className="flex items-center justify-center gap-1 transition hover:text-white">
         <FaInstagram /> Instagram
        </a>

        <a href="https://facebook.com" className="flex items-center justify-center gap-1 transition hover:text-white">
          <CiFacebook scale={200}/> Facebook
        </a>

        <a href="https://www.linkedin.com/" className="flex items-center justify-center gap-1 transition hover:text-white">
          <CiLinkedin/> Linkedin
        </a>
      </div>
    </div>
  ...
  <div className="mx-auto mt-16 flex max-w-7xl flex-col gap-4 border-t border-white/10 pt-6 text-xs uppercase tracking-[0.2em] text-neutral-500 md:flex-row md:items-center md:justify-between">
    ...
    <p>Designed with modern minimalism.</p>
  </div>
</footer>
    )
}